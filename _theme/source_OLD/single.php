...
<div class="single single-noticias">
	<div class="container no-padding">

		<div class="breadcrumbs">
			<span class="location"> <a href="<?php echo get_permalink( get_page_by_title( 'noticias' ) ); ?>" class="link"><?php echo _e('Notícias', 'servix') ?></a> </span> > <span class="location"> <a href="<?php echo get_permalink( $post ); ?>" class="link"><?php echo $post->post_title; ?></a> </span>
		</div>
					...
					<div class="the-post">
						...
						<div class="more-info">
							...
							<a href="<?php echo get_permalink( get_page_by_title( 'noticias' ) ); ?>" class="voltar">
								...
								<span class="text"><?php echo _e('Voltar para notícias', 'servix') ?></span>
							</a>
						</div>
					</div>
				</div>
