				...
				<div class="post">
					...
					<div class="the-post">
						...
						<div class="post-body">
							...
							<a href="<?php echo get_permalink( $post->ID ); ?>" class="leia-mais"> <span class="text"><?php echo _e('Leia mais', 'servix') ?></span> <span class="icon icon-arrow-right"></span> </a>
						</div>
					</div>
				</div>
			</div>
...
<?php if(!empty($total_pages-1)): ?>
	<ul class="pagination">
		<?php if(($pg-1)>=1): ?>
			<li><a href="<?php echo site_url('noticias'); ?>?pg=<?php echo $pg-1; ?>">&laquo;</a></li>
		<?php endif; ?>
		<?php for ($p=1; $p <= $total_pages; $p++) : ?>
		<li>
			<a href="<?php echo site_url('noticias').'?pg='.$p;?>"><?php echo $p; ?></a>
		</li>
		<?php endfor;?>
		<?php if(($pg+1)<$total_pages): ?>
			<li><a href="<?php echo site_url('noticias'); ?>?pg=<?php echo $pg+1; ?>">&raquo;</a></li>
		<?php endif; ?>
	</ul>
	<?php endif; ?>
